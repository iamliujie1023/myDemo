package com.example.liuj.liujdemo.module.NestedScrolling.old;
...
public class StickyNavLayoutOld extends LinearLayout {
    ...
    public StickyNavLayoutOld(Context context, AttributeSet attrs) {
        super(context, attrs);
