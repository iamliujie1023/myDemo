...
public class NormalHolder extends BaseHolder<NormalModel> {
    ...
    public static NormalHolder newInstance(Context context, ViewGroup viewGroup) {
        return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.rv_item_normal_layout, viewGroup, false));
    }
